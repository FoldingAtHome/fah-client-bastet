...
LicenseLangString MUILicense ${LANG_GREEK} ".\Resources\GPL3_Greek_el.rtf"
...
LicenseLangString MUILicense ${LANG_LITHUANIAN} ".\Resources\GPL3_Lithuanian_lt.rtf"
...
LangString DataText ${LANG_LITHUANIAN} "Duomenų"
